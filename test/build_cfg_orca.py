...
ORCA_BUILDS = \
              [
                  Alt_Orca_BuildCfg(system='de2-115',
                                    ...
                                    interrupt_vector=0x00000200,
                                    iuc_addr_base=0,
                                    iuc_addr_last=0,
                                    iaux_addr_base=0,
                                    iaux_addr_last=0xFFFFFFFF,
                                    icache_size=0,
                                    duc_addr_base=0,
                                    duc_addr_last=0,
                                    daux_addr_base=0,
                                    daux_addr_last=0xFFFFFFFF,
                                    dcache_size=0),
                  Xil_Orca_BuildCfg(system='zedboard',
                                    reset_vector=0xB0000000,
                                    interrupt_vector=0xB0000200,
                                    iuc_addr_base=0,
                                    iuc_addr_last=0,
                                    iaux_addr_base=0,
                                    iaux_addr_last=0xFFFFFFFF,
                                    ...
                                    daux_addr_base=0xB0000000,
                                    daux_addr_last=0xBFFFFFFF,
                                    dcache_size=0,
                  ...
                  Xil_Orca_BuildCfg(system='zedboard',
                                    ...
                                    uart_cfg=ZEDBOARD_UART_CFG),
                  Xil_Orca_BuildCfg(system='zedboard',
                                    reset_vector=0xA0000000,
                                    interrupt_vector=0xA0000200,
                                    iuc_addr_base=0,
                                    iuc_addr_last=0,
                                    iaux_addr_base=0,
                                    iaux_addr_last=0,
