...
void print_base64(char* in_str, int in_len)
{
	...
	for(i = 0;i<in_len;i+=3){
		...
		mputc(0,base_64_table[b64.index_a]);
		mputc(0,base_64_table[b64.index_b]);
		mputc(0,i+1<in_len?base_64_table[b64.index_c]:'=');
		mputc(0,i+2<in_len?base_64_table[b64.index_d]:'=');
	}
