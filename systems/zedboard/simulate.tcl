...
proc reset_sim { } {
    ...
    catch { reset_target simulation [get_files *orca_system_cached.bd] }
    exec rm -rf project/project.ip_user_files
    update_ip_catalog -rebuild -scan_changes
    upgrade_ip [get_ips *]
    report_ip_status -name ip_status
    generate_target simulation [get_files *orca_system_cached.bd]
}
...
proc start_sim { {run_time 0} } {
    ...
    add_force /orca_system_cached_wrapper/orca_system_cached_i/processing_system7_0_FCLK_RESET0_N 0 0us 1 $reset_time
    ...
    #when synthesized
    add_force /orca_system_cached_wrapper/orca_system_cached_i/processing_system7/S_AXI_GP0_ACLK 0 0us

    #Turn on UART bypass module
    add_force /orca_system_cached_wrapper/orca_system_cached_i/xlconstant_bypass_ps7_uart_dout   1 0us
    ...
    if { $run_from_idram } {
        ...
        foreach line $data {
            ...
            foreach word $words {
                ...
                set_value "/orca_system_cached_wrapper/orca_system_cached_i/idram/U0/ram/\\idram_gen(0)\\/tdp_ram/ram[$i]" -radix hex $byte0 
                set byte1 ""
                append byte1 [string index $word 4]
                append byte1 [string index $word 5]
                set_value "/orca_system_cached_wrapper/orca_system_cached_i/idram/U0/ram/\\idram_gen(1)\\/tdp_ram/ram[$i]" -radix hex $byte1
                set byte2 ""
                append byte2 [string index $word 2]
                append byte2 [string index $word 3]
                set_value "/orca_system_cached_wrapper/orca_system_cached_i/idram/U0/ram/\\idram_gen(2)\\/tdp_ram/ram[$i]" -radix hex $byte2 
                set byte3 "" 
                append byte3 [string index $word 0]
                append byte3 [string index $word 1]
                set_value "/orca_system_cached_wrapper/orca_system_cached_i/idram/U0/ram/\\idram_gen(3)\\/tdp_ram/ram[$i]" -radix hex $byte3 
                set i [expr {$i + 1}]
            }
        }
    }
