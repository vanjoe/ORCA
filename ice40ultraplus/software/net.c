...
layer_t cifar_reduced[] = {
	...
	{.conv={CONV, RELU, 0, 8, 8, 16, 32, 0, REDUCED_FLASH_DATA_OFFSET+1328, 1, 1}},
	{.conv={CONV, RELU, 0, 8, 8, 32, 32, 1, REDUCED_FLASH_DATA_OFFSET+2608, 1, 0}},
	{.dense={DENSE, RELU, 0, 512, 64, REDUCED_FLASH_DATA_OFFSET+4912, REDUCED_FLASH_DATA_OFFSET+9008, 1, REDUCED_FLASH_DATA_OFFSET+9264}},
	{.dense={DENSE, RELU, 0, 64, 64, REDUCED_FLASH_DATA_OFFSET+9520, REDUCED_FLASH_DATA_OFFSET+10032, 1, REDUCED_FLASH_DATA_OFFSET+10288}},
	{.dense={DENSE, LINEAR, 1, 64, 2, REDUCED_FLASH_DATA_OFFSET+10544, REDUCED_FLASH_DATA_OFFSET+10560, 1, REDUCED_FLASH_DATA_OFFSET+10568}},
};
#endif
