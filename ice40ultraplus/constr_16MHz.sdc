...
create_clock -period 10.415 -name {sub_top.pll_2x_gen_pll_x2.uut/PLLOUTCORE}   [get_pins {sub_top.pll_2x_gen_pll_x2.uut/PLLOUTCORE}]
create_clock -period 10.415 -name {sub_top.pll_2x_gen_pll_x2.uut/PLLOUTGLOBAL} [get_pins {sub_top.pll_2x_gen_pll_x2.uut/PLLOUTGLOBAL}]
create_clock -period 37.04  -name {cam_xclk_internal}                          [get_nets {cam_xclk_internal}] 
create_clock -period 20.83  -name {sub_top.clk_3x}                             [get_nets {sub_top.clk_3x}] 
create_clock -period 62.49  -name {sub_top.clk}                                [get_nets {sub_top.clk}] 
...
set_max_delay -from [get_clocks {sub_top.clk}]    -to [get_clocks {sub_top.clk_3x}] 19.83
set_max_delay -from [get_clocks {sub_top.clk_3x}] -to [get_clocks {sub_top.clk}]    19.83
